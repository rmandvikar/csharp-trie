...
public class TrieTest
{
	...
	public void GetLongestPrefixMatch01(string expected, string prefix)
	{
		var trie = BuildSampleTrie();
		var longestPrefixMatch = trie.GetLongestPrefixMatch(prefix);
		Assert.AreEqual(expected, longestPrefixMatch);
	}

	[Test]
	[TestCase("", "bomb!")]
	public void GetLongestPrefixMatch02(string expected, string prefix)
	{
		var trie = BuildSampleTrie();
		trie.AddWord("");
		var longestPrefixMatch = trie.GetLongestPrefixMatch(prefix);
	...
	[TestCase(null, "child")]
	public void GetLongestPrefixMatch03(string expected, string prefix)
	{
